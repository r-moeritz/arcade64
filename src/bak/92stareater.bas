...
20 print"{black}{clear}":fg=81:cf=4:m=0:gosub 600
...
599 rem
600 print"      star eater":print"{down}{down}choose your level:"
605 print"1 - easy":print"2 - hard":print"3 - superhuman"
610 n=peek(197):if n=64 then 610
620 n=400+120*(n=59)+250*(n=8):print"{clear}":return
697 rem
