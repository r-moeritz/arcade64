10 dim s$(4),hr(7),cl$(5)
20 cc=14:ch=cc*1024:sc=1024
30 print "{brown}{clear}":poke 53272,(peek(53272) and 240) or cc
40 gosub 1100:gosub 1200
50 cl$(0)="{orange}":cl$(1)=chr$(144):cl$(2)="{gray}":cl$(3)=chr$(158)
60 cl$(4)="{red}":cl$(5)=chr$(5)
100 gosub 900
110 get c$:if c$="" then 110
120 print"{clear}":goto 100
900 for i=0 to int(rnd(9)*12+5):h=int(rnd(9)*8):v=int(rnd(9)*5)
910 cl=int(rnd(9)*5)
920 print cl$(cl)s$(v)tab(hr(h))a$:next
930 v=int(rnd(9)*5):h=int(rnd(9)*8):print cl$(5)s$(v)tab(hr(h))a$
940 return
...
1220 for i=0 to 7:hr(i)=i*5:next
1230 return
