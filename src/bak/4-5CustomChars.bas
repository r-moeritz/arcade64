...
130 poke 53281,15:print"{blue}"
140 for i=64 to 95:print"{home}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{down}{left}{left}"chr$(18)chr$(i)chr$(i+1)
...
1140 rem starship up,left,down,right
